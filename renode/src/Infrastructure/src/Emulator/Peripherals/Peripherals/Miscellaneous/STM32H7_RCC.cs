...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    ...
    public sealed class STM32H7_RCC : IDoubleWordPeripheral, IKnownSize
    {
        public STM32H7_RCC()
        {
            ...
            {
                {(long)Registers.InternalClockSourceCalibration, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "HSICAL/H48CAL/CSI")
                },
                ...
                {(long)Registers.PLLConfigurationRegister, new DoubleWordRegister(this, 0x01FF0000)
                    .WithValueField(0, 32, name: "PLLCFGR")
                },
                {(long)Registers.D1ClockConfiguration, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "D1CFGR")
                },
                {(long)Registers.D2ClockConfiguration, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "D2CFGR")
                },
                {(long)Registers.D3ClockConfiguration, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "D3CFGR")
                },
                {(long)Registers.PLLClockSelection, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "PLLCKSELR_ALIAS")
                },
                ...
                {(long)Registers.DomainKernelClockConfiguration, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "D1CCIPR")
                },
                {(long)Registers.ClockRecoveryRcRegister, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "CRRCR")
                },
                ...
                {(long)Registers.APB3Enable, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "APB3ENR")
                },
                {(long)Registers.APB4Enable, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "APB4ENR")
                },
                {(long)Registers.APB4Reset, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "APB4RSTR")
                },
                {(long)Registers.AHB1Enable, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "AHB1ENR")
                },
                {(long)Registers.AHB2Enable, new DoubleWordRegister(this, 0x0)
                    .WithValueField(0, 32, name: "AHB2ENR")
                }
            };
        ...
        private enum Registers
        {
            ...
            D1ClockConfiguration = 0x18,
            D2ClockConfiguration = 0x1C,
            D3ClockConfiguration = 0x20,
            PLLClockSelection = 0x54,
            DomainKernelClockConfiguration = 0x60,
            // ...
