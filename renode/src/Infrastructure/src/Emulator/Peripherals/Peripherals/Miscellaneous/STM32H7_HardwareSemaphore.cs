    ...
    public sealed class STM32H7_HardwareSemaphore : BasicDoubleWordPeripheral, IKnownSize
    {
        ...
        private void DefineRegisters()
        {
            ...
            Registers.InterruptClear.Define(this)
                .WithValueField(0, 32, name: "ICR");
            Registers.InterruptStatus.Define(this)
                .WithValueField(0, 32, name: "ISR");
            Registers.MaskedInterruptStatus.Define(this)
                .WithValueField(0, 32, name: "MISR");
            Registers.Cpu2InterruptEnable.Define(this)
                .WithValueField(0, 32, name: "C2IER");
            Registers.Cpu2InterruptClear.Define(this)
                .WithValueField(0, 32, name: "C2ICR");
            Registers.Cpu2InterruptStatus.Define(this)
                .WithValueField(0, 32, name: "C2ISR");
            Registers.Cpu2MaskedInterruptStatus.Define(this)
                .WithValueField(0, 32, name: "C2MISR");
        }
        ...
        private enum Registers
        {
            ...
            Cpu2InterruptEnable = 0x110,
            Cpu2InterruptClear = 0x114,
            Cpu2InterruptStatus = 0x118,
            Cpu2MaskedInterruptStatus = 0x11c,
            Clear = 0x140,
            Key = 0x144
        }
    }
