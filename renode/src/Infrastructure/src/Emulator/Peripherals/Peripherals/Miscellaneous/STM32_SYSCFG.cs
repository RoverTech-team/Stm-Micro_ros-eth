...
namespace Antmicro.Renode.Peripherals.Miscellaneous
{
    public sealed class STM32_SYSCFG : IDoubleWordPeripheral, INumberedGPIOOutput, IKnownSize, ILocalGPIOReceiver
    {
        ...
        private DoubleWordRegisterCollection CreateRegisters()
        {
            ...
            map.Add((long)Registers.MemoryRemap, new DoubleWordRegister(this, 0x0)
                .WithValueField(0, 32, name: "MEMRMP"));
            map.Add((long)Registers.PeripheralModeConfiguration, new DoubleWordRegister(this, 0x0)
                .WithValueField(0, 32, name: "PMC"));
            ...
            map.Add((long)Registers.PowerControl, new DoubleWordRegister(this, 0x0)
                .WithValueField(0, 32, name: "PWRCR"));
