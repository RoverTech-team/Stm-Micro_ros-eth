...
namespace Antmicro.Renode.Peripherals.IRQControllers
{
    public class STM32H7_EXTI : BasicDoubleWordPeripheral, IKnownSize, IIRQController, INumberedGPIOOutput
    {
        ...
        private void DefineRegisters()
        {
            ...
            RegistersCollection.DefineRegister((long)Registers.C2Pending1)
                .WithValueField(0, 32, name: "C2PR1");
            RegistersCollection.DefineRegister((long)Registers.C2Pending2)
                .WithValueField(0, 32, name: "C2PR2");
            RegistersCollection.DefineRegister((long)Registers.C2Pending3)
                .WithValueField(0, 32, name: "C2PR3");
        }
