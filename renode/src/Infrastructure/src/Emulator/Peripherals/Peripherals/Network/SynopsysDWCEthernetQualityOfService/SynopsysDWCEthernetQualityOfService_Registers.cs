        ...
        private IDictionary<long, DoubleWordRegister> CreateRegisterMap()
        {
            return new Dictionary<long, DoubleWordRegister>()
            {
                {(long)RegistersMacAndMmc.OperatingModeConfiguration, new DoubleWordRegister(this)
                    ...
                    .WithFlag(13, name: "MACCR.DM (DM)")
                    .WithFlag(14, name: "MACCR.FES (FES)")
                    .WithReservedBits(15, 1)
                    .WithTaggedFlag("MACCR.JD (JD)", 17)
                    .WithTaggedFlag("MACCR.JE (JE)", 16)
                    .WithReservedBits(18, 1)
                    .WithTaggedFlag("MACCR.WD (WD)", 19)
                    .WithFlag(20, name: "MACCR.ACS (ACS)")
                    .WithFlag(21, name: "MACCR.CST (CST)")
                ...
                {(long)RegistersMacAndMmc.ExtendedOperatingModeConfiguration, new DoubleWordRegister(this)
                    .WithValueField(0, 14, name: "MACECR.GPSL (GPSL)")
                ...
                {(long)RegistersMacAndMmc.OneMicrosecondTickCounter, new DoubleWordRegister(this)
                    .WithValueField(0, 12, name: "MAC1USTCR.TIC_1US_CNTR (TIC_1US_CNTR)")
                ...
                {(long)RegistersMacAndMmc.MMCRxInterruptMask, new DoubleWordRegister(this)
                    ...
                    .WithFlag(6, name: "MMC_RX_INTERRUPT_MASK.RXALGNERPIM (MMC Receive Alignment Error Packet Counter Interrupt Mask)")
                    ...
                    .WithFlag(26, name: "MMC_RX_INTERRUPT_MASK.RXLPIUSCIM (MMC Receive LPI Microsecond Counter Interrupt Mask)")
                    .WithFlag(27, name: "MMC_RX_INTERRUPT_MASK.RXLPITRCIM (MMC Receive LPI Transition Counter Interrupt Mask)")
                    .WithReservedBits(28, 4)
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
                {(long)RegistersMacAndMmc.MMCTxInterruptMask, new DoubleWordRegister(this)
                    ...
                    .WithFlag(14, name: "MMC_TX_INTERRUPT_MASK.TXSCOLGPIM (MMC Transmit Single Collision Good Packet Counter Interrupt Mask)")
                    .WithFlag(15, name: "MMC_TX_INTERRUPT_MASK.TXMCOLGPIM (MMC Transmit Multiple Collision Good Packet Counter Interrupt Mask)")
                    ...
                    .WithFlag(26, name: "MMC_TX_INTERRUPT_MASK.TXLPIUSCIM (MMC Transmit LPI Microsecond Counter Interrupt Mask)")
                    .WithFlag(27, name: "MMC_TX_INTERRUPT_MASK.TXLPITRCIM (MMC Transmit LPI Transition Counter Interrupt Mask)")
                    .WithReservedBits(28, 4)
                    .WithChangeCallback((_, __) => UpdateInterrupts())
                },
        ...
        private IDictionary<long, DoubleWordRegister> CreateMTLRegisterMap()
        {
            return new Dictionary<long, DoubleWordRegister>()
            {
                ...
                {(long)RegistersMTL.TxQueueOperating, new DoubleWordRegister(this, 0x70008)
                    .WithFlag(0, name: "MTLTxQOMR.FTQ (Flush Transmit Queue)")
                    .WithFlag(1, name: "MTLTxQOMR.TSF (Transmit Store and Forward)")
                ...
                {(long)RegistersMTL.RxQueueOperatingMode, new DoubleWordRegister(this)
                    ...
                    .WithFlag(5, name: "MTLRxQOMR.RSF (RSF)")
        ...
        private IDictionary<long, DoubleWordRegister> CreateDMARegisterMap()
        {
            var map = new Dictionary<long, DoubleWordRegister>()
            {
                ...
                {(long)RegistersDMA.SystemBusMode, new DoubleWordRegister(this)
                    .WithFlag(0, name: "DMASBMR.FB (Fixed Burst Length)")
