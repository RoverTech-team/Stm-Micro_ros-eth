...
/* Keep the lwIP heap above the ETH DMA descriptors and RX pool in D2 SRAM.
 * The CM7 map currently places .lwip_sec up to 0x30004b84, so 0x30005000
 * is the first safe 4 KB-aligned heap base that avoids metadata overlap.
 */
